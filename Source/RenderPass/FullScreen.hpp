...
public:
	...
	void AddShader(std::string shaderPath, VkShaderStageFlagBits shaderStageBits) {

		VkPipelineShaderStageCreateInfo shaderStageCI = vks::tools::loadShader(getShaderBasePath() + shaderPath, shaderStageBits, vulkanDevice->logicalDevice);
